...
from utils.plots import plot_one_box_colab
...
opt = {
  'weight': '/content/drive/MyDrive/LPRecognition/yolov7/LP_detect_yolov7_500img.pt',
	'source': '0',
	'img_size': 640,
	'conf_thres': 0.25,
	'iou_thres': 0.45,
                ...
                if len(det):
                  ...
                  if USE_SORT_TRACKER:
                    ...
                    for track in track_ids:
                      ...
                      plot_one_box_colab([x1, y1, x2, y2], img0, label=label, line_thickness=4)
                  else:
                      # Write results
                      for x1, y1, x2, y2, conf, detclass in det.cpu().detach().numpy():
                        license_plate_text = read_license_plate(img0, x1, y1, x2, y2)
                        ...
                        plot_one_box_colab([x1, y1, x2, y2], bbox_array, label=label, line_thickness=4)
